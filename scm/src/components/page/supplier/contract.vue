    ...
    <div class="list-wrap">
      ...
      <div class="container-list ">
        <el-table ref="multipleTable" :data="contractTable" class="table" @row-click="getDetail">
          ...
          <el-table-column prop="partyBContactName" label="联系人"></el-table-column>
          <el-table-column prop="partyBContactMobile" label="电话"></el-table-column>
...
<script>
  export default {
    ...
    methods: {
        ...
        getDetail(row) { 
            this.$router.push({ name: "ContractDetail", params: { id: row.id } });
        }
    }
  };
